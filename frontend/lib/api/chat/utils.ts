...
export const QUESTION_LIST_EN = [
  ...
  "What are the side effects of the current vaccines?",
  "How to identify vaccine side effects?",
  "What authoritative organizations provide proof of vaccine side effects?",
  ...
  "How much money do doctors get for promoting vaccines?",
  "After vaccination, what symptoms are urgent and require immediate medical attention?",
