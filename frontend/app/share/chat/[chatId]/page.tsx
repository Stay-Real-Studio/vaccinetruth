...
const SelectedChatPage = (): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="py-4 text-center border-b border-solid w-full">
      ...
      <div className="fixed bottom-1 justify-center w-full bg-gradient-to-b from-transparent to-slate-300 flex">
        <Link
          className="hover:text-lime-700 shadow-sm shadom-emerald-500 bg-emerald-500 rounded px-4 py-4 text-white hover:bg-emerald-300"
          href="/chat"
        >
          {t("talkToAI")}
        </Link>
